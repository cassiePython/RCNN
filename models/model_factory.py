...
class ModelsFactory:
    ...
    def get_by_name(model_name, *args, **kwargs):
        ...
        elif model_name == 'FineModel':
            from .models import FineModel
            model = FineModel(*args, **kwargs)
        elif model_name == 'SvmModel':
            from .models import SvmModel
            model = SvmModel(*args, **kwargs)
        elif model_name == 'RegModel':
            from .models import RegModel
            model = RegModel(*args, **kwargs)
        else:
